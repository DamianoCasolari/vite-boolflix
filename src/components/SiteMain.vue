...
<template>
    <main>
        <ul class="d-flex flex-wrap align-items-center justify-content-start">
            <li class="col col-12 col-md-6 col-lg-3 col-xxl-2 d-flex justify-content-center"
                v-for="movie, index in store.listMovies" @mouseover="" @mouseleave="">
                <div class="Cover_container position-relative">
